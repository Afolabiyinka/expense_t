import welcomeSvg from "../../assets/Svg/undraw_welcome-aboard_y4e9.svg";
        ...
        <form className="flex flex-col gap-4" onSubmit={handleUser}>
          ...
          <span className="flex gap-3 items-center">
            ...
            <input
              ...
              className="w-[16rem] h-[3.5rem] border border-custom-border focus:ring-1  rounded-full p-3 font-serif bg-inherit outline-0 text-black"
            />
          </span>
          <CustomBtn text="Continue" isSolid />
        </form>
      </motion.div>
      <motion.div
