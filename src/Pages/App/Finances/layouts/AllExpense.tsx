...
const AllExpense = () => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col md:w-full w-full  h-full border border-m-accent gap-3 rounded-3xl p-3 overflow-y-scroll"
    >
      {transactions && transactions.length > 0 ? (
        ...
        >
          <input
            type="search"
            className=" outline-0 p-3 border border-m-accent focus:border-none pl-4 rounded-3xl w-[90%] lg:w-[40%] mb-4 focus:ring-1 focus:ring-m-accent"
            placeholder="Search.."
            value={searchQuery}
